	...
	return LaunchDescription(
		[
			...
			DeclareLaunchArgument(
				'sequence',
				default_value='[[pose, post_grasp], [gripper, open], [record, start], [pose, grasp_pose], [gripper, close], [pose, post_grasp], [record, end]]',
			),
			...
			DeclareLaunchArgument('trial_count', default_value='1'),
				...
				parameters=[
					{
						...
						'trial_count': ParameterValue(LaunchConfiguration('trial_count'), value_type=int),
						'trigger_retention_recording_on_close': True,
						'trigger_retention_recording_service': '/trigger_retention_recording',
						'end_retention_recording_service': '/end_retention_recording',
					}
				],
			),
			Node(
				...
				parameters=[
					{
						...
						'default_trial_id': ParameterValue(LaunchConfiguration('trial_id'), value_type=str),
